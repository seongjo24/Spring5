...
auth_vue={
		...
		join_body:()=>{
	        ...
	        '        </div>'+
	        '        <div class="mb-3">'+
	        '          <label for="address2">password<span class="text-muted">(Optional)</span></label>'+
	        '          <input type="text" class="form-control" id="cpw" placeholder="Apartment or suite">'+
	        '        </div>'+
	        '        <div class="mb-3">'+
	        ...
	        '            </div>'+
	        '            <input type="text" class="form-control" id="cname" placeholder="Username" required="">'+
