...
brd_vue={
	    ...
	    brd_body: ()=>{
	        ...
	        '        </div>'+
	        '      </div>'+
	        '      <div id = "brdText" class="my-3 p-3 bg-white rounded box-shadow">'+
	        ...
	        '        </small>'+
	        '      </div>'+
	        '      <div id = brdText2 class="my-3 p-3 bg-white rounded box-shadow">'+
	    ...
	    brd_write: ()=>{
	    	  return '<div id="write_main"class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded box-shadow">'+
		        '        <img class="mr-3" src="https://getbootstrap.com/docs/4.0/assets/brand/bootstrap-outline.svg" alt="" width="48" height="48">'+
		        '        <div class="lh-100">'+
		        ...
		        '        </div>'+
		        '      </div>'+ 
	    	  '<div id = "write_div" class="container-fluid" style="width:80%">'
	    	  +'<h1>ARTICLE WRITING</h1>'
	    	  +'<form id ="write_form">'
	    	  +'<input type="text" name="writer" style="margin-top:20px" class="form-control" value="" />'
	    ...
	    brd_main: ()=>{
	    	return'    <main id="main" role="main" class="container">'+
		        '      <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded box-shadow">'+
		        '        <img class="mr-3" src="https://getbootstrap.com/docs/4.0/assets/brand/bootstrap-outline.svg" alt="" width="48" height="48">'+
		        '        <div class="lh-100">'+
		        '          <h6 class="mb-0 text-white lh-100">게시판</h6>'+
